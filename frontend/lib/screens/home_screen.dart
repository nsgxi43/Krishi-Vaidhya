            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  GestureDetector(
                    onTap: () => Provider.of<ConnectivityProvider>(context,
                            listen: false)
                        .recheck(),
                ...
                _buildToolCard(
                  ...
                  isOnline
                      ? () => Navigator.push(context,
                          MaterialPageRoute(
                              builder: (_) => const AgriStoreScreen()))
                      : null,
                ),
                _buildToolCard(
    ...
    return GestureDetector(
      onTap: disabled
          ? () => ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(
                  content: Text('This feature requires an internet connection.'),
      ...
      child: Opacity(
        ...
        child: Container(
          decoration: BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(
                  color: iconColor.withOpacity(disabled ? 0.03 : 0.08),
                  blurRadius: 6,
